...
class Screen_Compute: #come up with a better name
    ...
    def __init__(self, yaml_path='parameters.yaml'):
        ...
        # Get the files
        files = self.data_retrieve.query_data_updated(self.parameters['location_parameters']['exp_folder'],plate_type= self.parameters['location_parameters']['plate_type'],pattern=self.parameters['location_parameters']['fname_pattern'])
