    ...
    def compute_vector(self,well):
        ...
        for site in sites:
            ...
            if np_images is not None:
                ...
                if self.AWS_params['csv_coordinates']=='' or self.AWS_params['csv_coordinates'] is None:
                        ...
                        try:
                            ...
                            if isinstance(scalefex, pd.DataFrame):
                                ...
                                csv_file = dq.save_csv_file(vector, csv_file, self.AWS_params['max_file_size'],
                                        self.AWS_params['s3_bucket'], self.AWS_params['experiment_name'],
                                        self.plate, self.AWS_params['subset_index'])
...
### Start computation
    ...
    def start_computation(self,plate,files):
        ...
        if self.AWS_params['csv_coordinates'] is not None and os.path.exists(self.AWS_params['csv_coordinates']):
