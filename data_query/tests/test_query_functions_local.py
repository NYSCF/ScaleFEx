...
def test_make_well_and_field_lists():
    csv_file = os.path.join('/'.join(__file__.split('/')[:-1]),'sample_data/rxrx2/test_query_data_expected_output.csv')
...
def test_check_if_file_exists():
    csv_file = os.path.join('/'.join(__file__.split('/')[:-1]),'sample_data/rxrx2/test_query_data_expected_output.csv')
    coords_file = os.path.join('/'.join(__file__.split('/')[:-1]),'sample_data/rxrx2/test_coords.csv')
...
def test_flat_field_correction_on_data():
    img_dir = os.path.join('/'.join(__file__.split('/')[:-1]),'sample_data/zstack')
    ffc_file = os.path.join('/'.join(__file__.split('/')[:-1]),'sample_data/ffc/ffc.npy')
...
def test_flat_field_correction_on_data_bf():
    img_dir = os.path.join('/'.join(__file__.split('/')[:-1]),'sample_data/zstack')
    ffc_file = os.path.join('/'.join(__file__.split('/')[:-1]),'sample_data/ffc/bf-ffc.npy')
